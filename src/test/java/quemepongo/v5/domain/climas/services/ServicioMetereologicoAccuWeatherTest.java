...
import quemepongo.v5.domain.climas.services.ServicioMetereologicoAccuWeather;

class ServicioMetereologicoAccuWeatherTest {

  private AccuWeatherAPI apiMock;
  private quemepongo.v5.domain.climas.services.ServicioMetereologicoAccuWeather servicio;
